package com.gabriel.modelagem.resources.exception;
...
import com.gabriel.modelagem.services.exceptions.FileException;
...
public class ResourcesExceptionHandler {
	...
	public ResponseEntity<StandardError> amazonClient(AmazonClientException e, HttpServletRequest request) {
		StandardError err = new StandardError(System.currentTimeMillis(), HttpStatus.BAD_REQUEST.value(), "Erro de Amazon Client", e.getMessage(), request.getRequestURI());		
		return ResponseEntity.status(HttpStatus.BAD_REQUEST).body(err);
	}
